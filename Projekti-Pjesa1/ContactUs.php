...
<body>
    ...
    <nav class="navbar">
        ...
        <li class="nav-item">
           <a href="LoginRegister.php" class="nav-link">
            <svg 
            aria-hidden="true" 
            focusable="false" 
            data-prefix="fas" 
    ...
    <main>
        <div class="MainContainer" id="ContactContainer">
       <div class="box" id="ContactBox">
           <div class="content" id="ContactContent">
                <h3>Send us your ticket!</h3>
                <p>Hello cooking enthusiasts!</br>
                    We would love to hear about your recipes!</br>
                    Open a ticket and let us know which recipes
                    should we be adding to our website.
                </br>
            </p>
           </div>
       </div>

...
namespace ResumeApp.Controllers
{
    public class InformationController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,FullName,Email,Birthday,PhoneNumber,AboutMe,Experience,Skills,Hobbies")] Information information)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,FullName,Email,Birthday,PhoneNumber,AboutMe,Experience,Skills,Hobbies")] Information information)
        {
